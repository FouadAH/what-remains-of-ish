...
public class BlueBirbEnemy_FlyState : FlyState
{
    ...
    public BlueBirbEnemy_FlyState(Entity etity, FiniteStateMachine stateMachine, string animBoolName, D_FlyState stateData, BirbEnemy enemy) : base(etity, stateMachine, animBoolName, stateData)
    {
        this.enemy = enemy;
    }
