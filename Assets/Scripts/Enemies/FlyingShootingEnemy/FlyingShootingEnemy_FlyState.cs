...
public class FlyingShootingEnemy_FlyState : FlyState
{
    ...
    public FlyingShootingEnemy_FlyState(Entity etity, FiniteStateMachine stateMachine, string animBoolName, D_FlyState stateData, FlyingShootingEnemy enemy) : base(etity, stateMachine, animBoolName, stateData)
    {
        this.enemy = enemy;
    }
    ...
    public override void LogicUpdate()
    {
        ...
        if (entity.CheckPlayerInMaxAggroRadius() || enemy.IsAggro)
        {
            enemy.StopCoroutine(pathRoutine);
