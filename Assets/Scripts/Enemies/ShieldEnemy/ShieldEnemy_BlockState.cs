...
public class ShieldEnemy_BlockState : BlockState
{
    private ShieldEnemy enemy;
    protected bool isBlockOver;
    protected int hitAmount;

    public ShieldEnemy_BlockState(Entity etity, FiniteStateMachine stateMachine, string animBoolName, D_BlockState stateData, ShieldEnemy enemy) : base(etity, stateMachine, animBoolName, stateData)
    {
        this.enemy = enemy;
    }
